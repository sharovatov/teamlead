...
Теперь разберёмся со стоимостью оценки. Для этого необходимо разобрать типы оценок.
...
Эксперт или эксперты могут проанализировать задачу и выдать свой прогноз просто основываясь на своём опыте и знаниях.

Такая оценка имеет неизвестную прогностическую точность.
