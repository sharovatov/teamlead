...
### Ограничение количества «параллельных» (одной специализации) сотрудники
...
Если после всех этих упражнений окажется, что всё ещё нужно нанять человека, то идём к следующему критерию-фильтру: «Цена производства».
