...
В этом методе оценки нет необходимости в участии разработчиков.

Стоимость процедуры оценки зависит от «точности» сопоставления текущей задачи и набора каких-то подобных задач, выполненных ранее. Чем точнее нужно сопоставить, тем больше времени приходится тратить на декомпозицию и «погружение» в задачу.
...
Чем крупнее по объёму задача, тем меньше прогностическая точность такой оценки.

Эти два типа оценки лежат в основе практически всех систем прогнозирования сроков.
