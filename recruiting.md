...
Цель адаптации — максимально быстрый выход на оптимум производительности.

За адаптацию отвечает нанимающий менеджер. Рекрутер **не может** отвечать за качественную адаптацию сотрудника.
