...
Бизнес-модель компании прямо влияет на культуру.
...
Если тебе сделали оффер, но ты ещё трудоустроен и переживаешь, что оффер могут отозвать, когда ты уволишься, попроси подписать с тобой трудовой договор с оговоренной в оффере датой выхода. Закон это позволяет, и заодно поможет тебе избежать редкой, но всё же иногда происходящей проблемы — когда вдруг что-то в процессе согласования открытия штатной единицы идёт не так.

Проверь, что всё важное для тебя описано в оффере.

Если ты не переживаешь, что оффер могут отозвать (всё же такая ситуация редка), стоит всё равно попросить неподписанный экземпляр трудового договора для изучения.
...
Убедись, что заработная плата в оффере и в трудовом договоре соответствует договорённостям.

Если у компании есть юридическое лицо (и офис) в России, то единственным законным способом трудоустройства на постоянную основу является "оформление по ТК", когда в твою трудовую книжку вносится запись, и ты являешься официально трудоустроенным сотрудником.
...
- ждать или просить?
- как просить — рационально или «вот оффер»?

## Увольнение
- как красиво уйти?
- как быть, если тебя просят уйти?
- уходишь, дают контроффер, что делать?
