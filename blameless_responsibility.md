...
Нужно разобраться, есть ли экономически или как-то иначе проявляемый вред.

Кто этот процесс будет осуществлять? Вроде, как раз руководитель и должен заниматься, правда?

Проблемы:
- делегирование
- потеря информации при передаче руководителю
