...
Как было показано в прошлых пунктах, для того, чтобы работала адаптация, необходимо (но не достаточно) не ругать сотрудников за то, что они приносят информацию о проблемах и ошибках.
